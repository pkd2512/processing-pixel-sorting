...
void processPastel(PImage img, PImage pImg, float width, float height, int count) {
    img.loadPixels(); 
    pImg.loadPixels();
...
void processHatched(PImage img, PImage pImg, float width, float height, int count) {
    img.loadPixels(); 
    pImg.loadPixels();
...
void processSprinkles(PImage img, PImage pImg, float width, float height, int count) {
    img.loadPixels(); 
    pImg.loadPixels();
// int[] newPixels = sort(img.pixels);
...
void processSymmetry(PImage img, PImage pImg, float width, float height, int count) {
    img.loadPixels(); 
    pImg.loadPixels();
// int[] newPixels = sort(img.pixels);
...
void processThread(PImage img, PImage pImg, float width, float height, int count) {
    img.loadPixels(); 
    pImg.loadPixels();
// int[] newPixels = sort(img.pixels);
...
void processCluster(PImage img, PImage pImg, float width, float height, int count) {
    img.loadPixels(); 
    pImg.loadPixels();
// int[] newPixels = sort(img.pixels);
